...
public class FormMain extends javax.swing.JFrame {
   ...
   Connection conn = new ConnectionMySQL().getConnection();
    ...
    private void initComponents() {
        ...
        jLabel8.setForeground(new java.awt.Color(28, 21, 41));
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Artboard 1.png"))); // NOI18N
        jLabel8.setText(" SISTEM PEMESANAN HOTEL");

        l_tanggal.setFont(new java.awt.Font("Arial-Rounded", 0, 16)); // NOI18N
        l_tanggal.setForeground(new java.awt.Color(28, 21, 41));
        l_tanggal.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        l_tanggal.setText("Tanggal");

        l_jam.setFont(new java.awt.Font("Arial-Rounded", 0, 16)); // NOI18N
        l_jam.setForeground(new java.awt.Color(28, 21, 41));
        l_jam.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        l_jam.setText("Jam");

        l_id_admin1.setFont(new java.awt.Font("Arial-Rounded", 0, 20)); // NOI18N
        l_id_admin1.setForeground(new java.awt.Color(28, 21, 41));
        l_id_admin1.setText("User : ");

        l_id_admin.setFont(new java.awt.Font("Arial-Rounded", 0, 20)); // NOI18N
        l_id_admin.setForeground(new java.awt.Color(28, 21, 41));
        l_id_admin.setText("Admin");

        l_admin.setFont(new java.awt.Font("Arial-Rounded", 0, 20)); // NOI18N
        l_admin.setForeground(new java.awt.Color(28, 21, 41));
        l_admin.setText("Admin");

        b_logout.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_logout.setForeground(new java.awt.Color(28, 21, 41));
        ...
        b_refersh_kamar.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_refersh_kamar.setForeground(new java.awt.Color(28, 21, 41));
        b_refersh_kamar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/refresh_1.png"))); // NOI18N
        ...
        b_tambah_kamar.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_tambah_kamar.setForeground(new java.awt.Color(28, 21, 41));
        b_tambah_kamar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/add-button.png"))); // NOI18N
        ...
        b_edit_kamar.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_edit_kamar.setForeground(new java.awt.Color(28, 21, 41));
        b_edit_kamar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/edit (1).png"))); // NOI18N
        ...
        b_delete_kamar.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_delete_kamar.setForeground(new java.awt.Color(28, 21, 41));
        b_delete_kamar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/delete_1.png"))); // NOI18N
        ...
        b_cari_kamar.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_cari_kamar.setForeground(new java.awt.Color(28, 21, 41));
        b_cari_kamar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/search_3.png"))); // NOI18N
        ...
        b_refersh_tamu.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_refersh_tamu.setForeground(new java.awt.Color(28, 21, 41));
        b_refersh_tamu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/refresh_1.png"))); // NOI18N
        ...
        b_tambah_tamu.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_tambah_tamu.setForeground(new java.awt.Color(28, 21, 41));
        b_tambah_tamu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/add_tamu.png"))); // NOI18N
        b_tambah_tamu.setText("Check In");
        ...
        b_cekout.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_cekout.setForeground(new java.awt.Color(28, 21, 41));
        b_cekout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/delete_tamu.png"))); // NOI18N
        b_cekout.setText("Check Out");
        ...
        b_history.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_history.setForeground(new java.awt.Color(28, 21, 41));
        b_history.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/history.png"))); // NOI18N
        ...
        b_cari_kamar2.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_cari_kamar2.setForeground(new java.awt.Color(28, 21, 41));
        b_cari_kamar2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/search_3.png"))); // NOI18N
        ...
        jLabel6.setBackground(new java.awt.Color(111, 168, 220));
        ...
        b_refersh_karyawan.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_refersh_karyawan.setForeground(new java.awt.Color(28, 21, 41));
        b_refersh_karyawan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/refresh_1.png"))); // NOI18N
        ...
        b_tambah_karyawan.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_tambah_karyawan.setForeground(new java.awt.Color(28, 21, 41));
        b_tambah_karyawan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/add-button.png"))); // NOI18N
        ...
        b_edit_karyawan.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_edit_karyawan.setForeground(new java.awt.Color(28, 21, 41));
        b_edit_karyawan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/edit (1).png"))); // NOI18N
        ...
        b_delete_karyawan.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_delete_karyawan.setForeground(new java.awt.Color(28, 21, 41));
        b_delete_karyawan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/delete_1.png"))); // NOI18N
        ...
        b_cari_karyawan.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_cari_karyawan.setForeground(new java.awt.Color(28, 21, 41));
        b_cari_karyawan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/search_3.png"))); // NOI18N
        ...
        t_cari_karyawan.setFont(new java.awt.Font("Arial-Rounded", 0, 14)); // NOI18N
        t_cari_karyawan.setForeground(new java.awt.Color(28, 21, 41));
            ...
            .addGroup(panel_karyawanLayout.createSequentialGroup()
                ...
                .addGroup(panel_karyawanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel_karyawanLayout.createSequentialGroup()
                        ...
                        .addGap(5, 5, 5)
                        .addComponent(b_refersh_karyawan))
    ...
    private void b_edit_karyawanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_edit_karyawanActionPerformed
        // TODO add your handling code here:
        FormAddEditKaryawan f_t_e_karyawan = new FormAddEditKaryawan(this, rootPaneCheckingEnabled);
