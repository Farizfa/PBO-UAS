...
public class FormAddEditKamar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        t_kode_kamar.setFont(new java.awt.Font("Arial-Rounded", 0, 14)); // NOI18N
        t_kode_kamar.setForeground(new java.awt.Color(28, 21, 41));
        ...
        t_lantai.setFont(new java.awt.Font("Arial-Rounded", 0, 14)); // NOI18N
        t_lantai.setForeground(new java.awt.Color(28, 21, 41));
        t_lantai.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                t_lantaiActionPerformed(evt);
            }
        });

        c_tipe_kamar.setFont(new java.awt.Font("Arial-Rounded", 0, 14)); // NOI18N
        c_tipe_kamar.setForeground(new java.awt.Color(28, 21, 41));
        c_tipe_kamar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- - Pilih - -", "VIP", "Bisnis", "Ekonomi" }));
        c_tipe_kamar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                c_tipe_kamarActionPerformed(evt);
            }
        });

        t_no_kamar.setFont(new java.awt.Font("Arial-Rounded", 0, 14)); // NOI18N
        t_no_kamar.setForeground(new java.awt.Color(28, 21, 41));

        b_simpan.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        b_simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/accept_1.png"))); // NOI18N
        ...
        t_harga_perkamar.setFont(new java.awt.Font("Arial-Rounded", 0, 14)); // NOI18N
        t_harga_perkamar.setForeground(new java.awt.Color(28, 21, 41));
    ...
    private void c_tipe_kamarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c_tipe_kamarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_c_tipe_kamarActionPerformed

    private void t_lantaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_t_lantaiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_t_lantaiActionPerformed
